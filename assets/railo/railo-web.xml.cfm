...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;useUnicode=true" database="hydra" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="hydra" password="encrypted:d4f6af6f32c87e1de778d40ba10b6fa566f93e916e52f85a501f70bbab0a94a2" port="3306" storage="false" username="hydra" validate="false"/>
	</data-sources>
...
<gateways>
  ...
  <gateway cfc-path="WEB-INF.railo.gateway.railo.extension.gateway.hydra" class="" custom="listenerFunction=onReady&amp;interval=500" id="test" listener-cfc-path="WEB-INF.railo.gateway.railo.extension.gateway.hydraListener" read-only="false" startup-mode="manual"/>
